<?php
    class Producto extends Conectar{ // Extiende de la clase padre Conectar
        public function get_producto(){
            ...
            parent::set_names();
            $sql = "SELECT tm_producto.prod_id, tm_producto.cat_id, tm_producto.prod_nom, tm_producto.prod_desc, tm_producto.prod_cant, tm_categoria.cat_nom FROM tm_producto INNER JOIN tm_categoria on tm_producto.cat_id = tm_categoria.cat_id WHERE tm_producto.est=1;";
